...
//   Profile({this.username, this.image, this.udid});
...
//   factory Post.fromForum(Profile profile) {
//     return Post(
...
//   @override
//   String toString() {
//     return 'Post{username: $username, image: $image}';
//   }
// }

//   Future<List<Profile>> fetchPostsFromServer() async {
...
//       List<Profile> posts =
//           forumData.map((data) => Profile.fromJson(data)).toList();
//       return posts;
//     } else {
...
class _ProfilePageState extends State<ProfilePage> {
  ...
  //     setState(() {
  //       posts = forumData
  //           .map((forum) => Post.fromForum(Profile.fromJson(forum)))
  //           .toList();
  //     });
  //   }
  // }
  ...
  //   try {
  //     List<Profile> forumData = await fetchPostsFromServer();
  //     setState(() {
