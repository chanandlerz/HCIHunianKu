              ...
              child: ElevatedButton(
                  ...
                  onPressed: () async {
                    ...
                    final RSAPublicKey publicKey =
                        parser.parse(_logicLogin.publicKeyString) as RSAPublicKey;

                    final String encryptedPassword =
                        _logicLogin.encryptMessage(passwordController.text, publicKey);

                    final String encryptedUsername =
                        _logicLogin.encryptMessage(usernameController.text, publicKey);
